...
import { listenToThaiStudentAccountSummary, updateThaiStudentAccountSummary, listenToThaiStudentTransactions, addThaiStudentTransaction, updateThaiStudentTransaction, deleteThaiStudentTransaction } from '@/services/thaiStudentAccountancyService';
...
export default function ThaiStudentAccountPage() {
    ...
    useEffect(() => {
        const unsubscribeSummary = listenToThaiStudentAccountSummary(setSummary);
        const unsubscribeTransactions = listenToThaiStudentTransactions(setTransactions);
        return () => {
            unsubscribeSummary();
    ...
    const handleAddTransaction = async (e: React.FormEvent) => {
        ...
        try {
            await addThaiStudentTransaction({
    ...
    const handleUpdateTransaction = async () => {
        ...
        try {
            await updateThaiStudentTransaction(editingTransaction.id, {
                ...editingTransaction,
    ...
    const handleDeleteTransaction = async (id: string) => {
        ...
        try {
            await deleteThaiStudentTransaction(id);
    ...
    return (
        <div className="flex min-h-screen w-full flex-col bg-muted/40">
            <header className="sticky top-0 z-30 flex h-14 items-center gap-4 border-b bg-background px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6">
                ...
                <h1 className="text-xl font-bold tracking-tight">ບັນຊີໄທ ນັກສຶກສາ</h1>
            </header>
